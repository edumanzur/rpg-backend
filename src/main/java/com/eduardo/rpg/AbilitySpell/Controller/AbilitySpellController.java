...
public class AbilitySpellController {
    ...
    @PostMapping
    public ResponseEntity<AbilitySpellResponseDTO> createAbilitySpell(@RequestBody @Valid CreateAbilitySpellRequest dto) {
    ...
    public ResponseEntity<AbilitySpellResponseDTO> updateAbilitySpell(
        ...
        @RequestBody @Valid UpdateAbilitySpellRequest dto) {
